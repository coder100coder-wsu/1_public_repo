...
def save_output_predictions(input_df, output_dir_name='output_predictions_',
                            output_sub_dir_name = "linear_regression",
                            counter=1,input_index_label='row_index'):
    """
    ...
    if output_dir_name in dirlist:
        output_file_dir_path = up_one_level_dir_path + "\\" + output_dir_name + "\\" \
                               + output_sub_dir_name + "\\"
        # print("output_file_dir_path=\n", output_file_dir_path)
        output_file_name = "run_" + str(counter) + ".csv"
        ...
        print("output_dir_name not found in current dir structure.")
        return -1
