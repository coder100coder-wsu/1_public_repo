...
def make_output_dir(input_path, output_dir_name='output_predictions'):
    """
    function creates output directory
    :param input_path: existing target/root dir where the output dir should be created
    ...
    base_file_name = os.path.basename(input_path)
